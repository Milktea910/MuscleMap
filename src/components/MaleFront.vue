<template>
  ...
  >
    <g>
      <g class="bodymap text-mw-gray" fill="none" id="calves">
        <g @click="goTo('front_calfs')">
          <path
            class="part"
    ...
    <g>
      <g fill="none">
        <g @click="goTo('abs')" data-muscle="abs">
          <path
            class="part"
    ...
    <g>
      <g fill="none">
        <g @click="goTo('flank')" data-muscle="flank">
          >
          <path
            class="part"
    ...
    <g>
      <g class="body-map__model" fill="none" id="body">
        <line
          fill="none"
          stroke="#484A68"
    ...
    <g>
      <g class="hidden" fill="none" id="shoulders">
        <g>
          <ellipse
            cx="441.13"
            cy="261.13"
    ...
    <g>
      <g class="hidden" fill="none" id="elbow">
        <g>
          <ellipse
            cx="118.6"
            cy="412.77"
    ...
    <g>
      <g class="hidden" fill="none" id="wrist">
        <g>
          <ellipse
            cx="42.41"
            cy="531.02"
    ...
    <!-- <g  >
      <g class="hidden" fill="none" id="hips">
        <g  >
          <ellipse
            cx="412.75"
            cy="523.37"
    ...
    <!-- <g  >
      <g class="hidden" fill="none" id="knees">
        <g  >
          <ellipse
            cx="419.37"
            cy="874.7"
    ...
    <!-- <g  >
      <g class="hidden" fill="none" id="ankles">
        <g  >
          <ellipse
            cx="221.14"
            cy="1105.65"
...
/* 重新啟用更精確的CSS選擇器 */
svg[data-highlighted-muscles*='front_calfs'] #calves .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='calves'] #calves .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='front_thighs'] #quads .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='quads'] #quads .part {
  fill: var(--highlight-color) !important;
}
...
svg[data-highlighted-muscles*='chests'] #chest .part {
  fill: var(--highlight-color) !important;
}

/* 移除會與 upper_chest 衝突的 chest 規則 */

svg[data-highlighted-muscles*='upper_chest'] #upper_chest .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='front_trapezius'] #traps .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='back_trapezius'] #traps .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='middle_shoulders'] #front-shoulders .part {
  fill: var(--highlight-color) !important;
}
...
svg[data-highlighted-muscles*='abs'] g[data-muscle='abs'] .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='flank'] g[data-muscle='flank'] .part {
  fill: var(--highlight-color) !important;
}
</style>
