<template>
  ...
  >
    <g @click="goTo('back_trapezius')" id="back-trapezius">
      <path
        class="part"
    ...
    <g @click="goTo('back_calfs')" id="back-calfs">
      >
      <path
        class="part"
    ...
    <g @click="goTo('back_thighs')" id="back-thighs">
      >
      <path
        class="part"
    ...
    <g @click="goTo('triceps')" id="triceps">
      >
      <path
        class="part"
    ...
    <g @click="goTo('lower_back')" id="lower-back">
      >
      <path
        class="part"
    ...
    <g @click="goTo('traps_middle')" id="traps-middle">
      >
      <path
        class="part"
    ...
    <g
      @click="goTo('back_shoulders')"
      id="posterior-deltoid"
      class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
    >
      <path
        class="part"
        d="M488,284.76c-7.37-.79-16.61-2.47-25.65-6.49-.04-.02-.07-.04-.13-.05-4.57-2.05-9.08-4.67-13.27-8.08-7.11-5.77-14.03-10.97-20.71-15.99-10.69-8.01-20.78-15.6-30.58-24.71,4.19-4.42,10.92-10.93,21.41-14.48,36.95,19.87,53.92,46.37,67.54,67.65l1.39,2.15Z"
        fill="#EBEBEB"
        stroke="#484A68"
        stroke-width="3"
      ></path>
      <path
        class="part"
        d="M262.87,229.44c-9.78,9.13-19.89,16.69-30.56,24.71-6.68,5.02-13.59,10.21-20.71,15.99-4.22,3.43-8.79,6.09-13.4,8.13-9.04,4.02-18.29,5.7-25.65,6.49l1.37-2.15c13.63-21.29,30.58-47.77,67.54-67.63h.02c10.47,3.55,17.22,10.04,21.39,14.46Z"
        fill="#EBEBEB"
        stroke="#484A68"
        stroke-width="3"
      ></path>
...
/* 背部小腿高亮 */
svg[data-highlighted-muscles*='back_calfs'] #back-calfs .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='calves'] #back-calfs .part {
  fill: var(--highlight-color) !important;
}

/* 大腿後側高亮 */
svg[data-highlighted-muscles*='back_thighs'] #back-thighs .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='hamstrings'] #back-thighs .part {
  fill: var(--highlight-color) !important;
}

/* 臀大肌高亮 */
svg[data-highlighted-muscles*='butts'] #butts .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='glutes'] #butts .part {
  fill: var(--highlight-color) !important;
}

/* 肱三頭肌高亮 */
svg[data-highlighted-muscles*='triceps'] #triceps .part {
  fill: var(--highlight-color) !important;
}

/* 背闊肌高亮 */
svg[data-highlighted-muscles*='lats'] #lats .part {
  fill: var(--highlight-color) !important;
}

/* 豎脊肌/下背高亮 */
svg[data-highlighted-muscles*='lower_back'] #lower-back .part {
  fill: var(--highlight-color) !important;
}

/* 斜方肌中段高亮 */
svg[data-highlighted-muscles*='traps_middle'] #traps-middle .part {
  fill: var(--highlight-color) !important;
}

/* 斜方肌背部高亮 */
svg[data-highlighted-muscles*='back_trapezius'] #back-trapezius .part {
  fill: var(--highlight-color) !important;
}
...
/* 後三角肌高亮 */
svg[data-highlighted-muscles*='back_shoulders'] #posterior-deltoid .part {
  fill: var(--highlight-color) !important;
}
