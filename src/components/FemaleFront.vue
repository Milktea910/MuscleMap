<template>
  <svg
    ...
    fill="none"
    :data-highlighted-muscles="highlightedMuscles.join(',')"
    :style="{ '--highlight-color': highlightColor }"
  >
    <g @click="goTo('front_calfs')" class="muscle-front_calfs" id="front-calfs">
      <path
        class="part"
    ...
    <g @click="goTo('front_thighs')" class="muscle-front_thighs" id="front-thighs">
      >
      <path
        class="part"
    ...
    <g @click="goTo('forearms')" id="forearms">
      >
      <path
        class="part"
    ...
    <g
      @click="goTo('upper_chest')"
      id="upper-pectoralis"
      class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
    >
      <path
        class="part"
        d="M460.97,287.52c-.28-.07-.54-.14-.8-.21-.35-.11-.72-.21-1.06-.32-.56-.18-1.06-.3-1.54-.42-.13-.02-.24-.05-.37-.09-40.81-11.6-56.28-23.72-71.27-35.46-10.6-8.31-21.56-16.88-41.35-25.15,6.13-2.04,14.84-3.5,27.21-3.45.33.05.69.07,1.06.07,1.19,0,2.32,0,3.39.04h.15c.43,0,.85.02,1.28.04h.06c14.3.44,18.14,2.94,24.03,7.67.02.02.06.04.07.05,11.23,9.8,31.88,28.72,59.13,57.23Z"
        fill="#EBEBEB"
        stroke="#484A68"
        stroke-width="3"
      ></path>
    ...
    <g
      @click="goTo('front_shoulders')"
      id="anterior-deltoid"
      class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
    >
      <path
        class="part"
        d="M464.01,289.19c-.7-.32-1.37-.6-2-.84-27.96-29.35-49.17-48.75-60.58-58.73-.91-.81-1.78-1.55-2.56-2.24-.43-.37-.56-.77-.43-1.2.19-.58.85-1.04,1.65-1.14,9.93-1.3,16.67-2.16,21.27-2.73,36.81,23.04,39.26,41.39,42.33,64.6l.32,2.27Z"
        fill="#EBEBEB"
        stroke="#484A68"
        stroke-width="3"
      ></path>
      <path
        class="part"
        d="M262.17,226.19c.13.42-.02.83-.43,1.2-.78.67-1.63,1.41-2.56,2.24-11.41,9.96-32.62,29.39-60.6,58.73l-.02.02c-.63.25-1.28.53-1.96.83l.3-2.27c3.09-23.21,5.54-41.57,42.35-64.6,4.58.56,11.34,1.43,21.27,2.73.8.11,1.45.56,1.65,1.14Z"
        fill="#EBEBEB"
        stroke="#484A68"
        stroke-width="3"
      ></path>
    ...
    <g @click="goTo('front_trapezius')" id="front-trapezius">
      >
      <path
        class="part"
...
watch(
  ...
  (newColor) => {
    if (!newColor) return // 防護檢查

    nextTick(() => {
      try {
        const svgElement = instance?.vnode?.el?.querySelector('svg')
        if (svgElement) {
          svgElement.style.setProperty('--highlight-color', newColor)
        }
      } catch (error) {
        console.warn('Error setting highlight color:', error)
      }
    })
  },
  { immediate: true },
...
function goTo(target) {
  try {
    ...
    if (props.customClickHandler) {
      props.customClickHandler(target)
      return
    }
    ...
    if (props.selectedEquipments && props.selectedEquipments.length > 0) {
      query.equipment = props.selectedEquipments.join(',')
    }
...
.part:hover {
  fill: rgba(248, 142, 165, 0.7);
  cursor: pointer;
}

/* 重新啟用更精確的高亮CSS */
svg[data-highlighted-muscles*='front_calfs'] #front-calfs .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='calves'] #front-calfs .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='front_thighs'] #front-thighs .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='quads'] #front-thighs .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='flank'] #flank .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='abs'] #abs .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='forearms'] #forearms .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='biceps'] #biceps .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='middle_shoulders'] #middle-shoulders .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='front_shoulders'] #anterior-deltoid .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='chests'] #chests .part {
  fill: var(--highlight-color) !important;
}

/* 移除會與 upper_chest 衝突的 chest 規則 */

svg[data-highlighted-muscles*='upper_chest'] #upper-pectoralis .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='front_trapezius'] #front-trapezius .part {
  fill: var(--highlight-color) !important;
}

svg[data-highlighted-muscles*='hands'] #hands .part {
  fill: var(--highlight-color) !important;
}
</style>
